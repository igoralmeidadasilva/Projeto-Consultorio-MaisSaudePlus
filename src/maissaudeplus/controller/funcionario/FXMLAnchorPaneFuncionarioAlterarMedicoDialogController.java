...
# instanciar uma conexão ao banco para alteraar um cadastro de médico que acordo com os     #
novos valores passados para o objeto médico.                                                #
#############################################################################################
*/
...
public class FXMLAnchorPaneFuncionarioAlterarMedicoDialogController implements Initializable {
    ...
    public void setMedico(Medico medico) {
        this.medico = medico;
        this.textFieldNome.setText(medico.getNome());
